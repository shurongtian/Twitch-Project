...
import com.thisisademo.demo1.entity.response.Game;
...
public class GameService {
    private static final String TOKEN = "Bearer wqyjx0o2pcd1s601w1buinx376jd0g";
    private static final String CLIENT_ID = "qs8jwek9r88eunn0tpiy11ypfpapep";
    ...
    public Game searchGame(String gameName){
        ...
        if (gameList.size() != 0) {  // if this is not checked, might give error index out of bound

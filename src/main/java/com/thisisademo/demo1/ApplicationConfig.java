...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.thisisademo.demo1.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "twitch-project.cr5fe09abiaz.us-east-2.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "offer1234";
